...
auto marching_cubes(
    const pyskip::Tensor<3, float>& lattice, float surface_density = 0.5) {
  SurfaceMesh mesh;
  ...
  auto shift = [&](int dx, int dy, int dz) {
    ...
    return pyskip::TensorSlice<3>({{x0, x1, 1}, {y0, y1, 1}, {z0, z1, 1}});
  };
...

  {
    ...
    auto mask = pyskip::splat<int>(l_000 >= surface_density, 0b00000001, 0) |
                pyskip::splat<int>(l_100 >= surface_density, 0b00000010, 0) |
                pyskip::splat<int>(l_010 >= surface_density, 0b00000100, 0) |
                pyskip::splat<int>(l_110 >= surface_density, 0b00001000, 0) |
                pyskip::splat<int>(l_001 >= surface_density, 0b00010000, 0) |
                pyskip::splat<int>(l_101 >= surface_density, 0b00100000, 0) |
                pyskip::splat<int>(l_011 >= surface_density, 0b01000000, 0) |
                pyskip::splat<int>(l_111 >= surface_density, 0b10000000, 0);
