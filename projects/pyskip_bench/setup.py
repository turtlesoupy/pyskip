        ...
        subprocess.check_call(
            args=platform_args(
                ...
                windows_args=[
                    ...
                    f"-DPYSKIP_BENCH_ENABLE_TACO=OFF",
                ],
                posix_args=[
                    f"-DCMAKE_BUILD_TYPE={config}",
                    f"-DCMAKE_VERBOSE_MAKEFILE:BOOL=ON",
                    f"-DPYSKIP_BENCH_ENABLE_TACO=ON",
                ],
            ),
            cwd=self.build_temp,
            env=env,
...
setup(
    ...
    description="Benchmarking tests for pyskip library",
    long_description="",
    ext_modules=[
        CMakeExtension("pyskip_bench", "pyskip_bench_cpp_ext"),
    ],
