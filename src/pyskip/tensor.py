...
class TensorBuilder:
    def __init__(self, shape, val, dtype):
        ...
        self._builder = getattr(_pyskip_cpp_ext, f"{_prefix_type_mapping[dtype]}Builder")(max_size, val)
...
class Tensor:
    ...
    def from_numpy(cls, np_arr):
        ...
        pyskip_arr = _pyskip_cpp_ext.from_numpy(np_arr.flatten("C"))
        return cls(shape=tuple(reversed(np_shape)), val=pyskip_arr)
    ...
    def _cpp_class(cls, shape, typ):
        ...
        return getattr(_pyskip_cpp_ext, name)
